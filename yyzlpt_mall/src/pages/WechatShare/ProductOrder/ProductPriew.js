 ...
 * @Last Modified by: wy
 * @Last Modified time: 2019-05-10 20:29:16
*/
...
@connect(({ order }) => ({
  ...
  // 商品详情banner
  productInfoImages: order.previewProductInfoImages,
  // 商品详情数据
  productInfoBoById: order.previewProductInfoBoById,
}))
class Index extends PureComponent {
  ...
  getGoodsDataByGoodsId = () => {
    ...
    dispatch({
      type: 'order/getPreviewGoodDetail',
      payload: {
  ...
  render() {
    ...
    const marketingPrice = productInfoBoById.marketingPrice
      ? productInfoBoById.marketingPrice
      : 0;
    return (
      <WingBlank className={styles.orderBox} style={{ marginLeft: 0, marginRight: 0 }}>
        ...
        <div className={styles.productContent}>
          ...
          <div className={styles.productServer}>
            ...
            {productInfoBoById &&
              ...
              productInfoBoById.productTagInfoBos.map(item => {
        ...
        <div className={styles.productList}>
          ...
          {/* 商品详情 */}
          {/* {showDetails ? */}
          <div className={styles.showProductDetails}>
            <h3>商品详情</h3>
            <div
              id="innerHtml"
        ...
        <div className={styles.footer}>
          <span className={styles.footerLeft}>
            ¥{marketingPrice > 0 ? marketingPrice : 0}
          </span>
        ...
        {isShow && (
          <ImgPreview currIndex={bannerIndex} imgList={productInfoImages} onClose={this.closeImg} />
        )}
      </WingBlank>
    );
  }
